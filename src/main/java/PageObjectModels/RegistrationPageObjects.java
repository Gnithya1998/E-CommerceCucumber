...
public class RegistrationPageObjects extends CommonPageObjects {
	...
	public String accInfoMsg() {

		return accInfoTxt.getText();
	}

	public void accountInformationForm(String password) {
